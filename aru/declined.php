			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12"><br><br>
						<h2 class="page-title" >Withdrawl Declined</h2>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from withdrawl where status=2 order by date desc";
...
<td><?php if($row->status==2 || $row->status==0)//onclick="return confirmation()"
{
	?><a href="declined.php?status1=<?php echo htmlentities($row->id);?>" onclick="return confirm('Approve Withdrawl')">Approve</a>
<?php } else {?>

<a href="declined.php?status=<?php echo htmlentities($row->id);?>" onclick="return confirm('Decline Withdrawl')">Decline </a>
</td>
<?php } ?></td>
