			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12"><br><br>
						<h2 class="page-title">Withdrawl Approved</h2>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from withdrawl where status=1 order by date desc";
...
{
	?><a href="approved.php?status1=<?php echo htmlentities($row->id);?>" onclick="return confirm('Approve Withdrawl')">Approve</a>
<?php } else {?>

<a href="approved.php?status=<?php echo htmlentities($row->id);?>" onclick="return confirm('Decline Withdrawl')">Decline </a>
</td>
<?php } ?></td>
