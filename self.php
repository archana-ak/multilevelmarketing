...
//$sponso=mysqli_escape_string($mysqli,$_POST['sponsor']);
...
<div class='col-sm-8'>
<input type='text' name='sponsor' id='sponsor' onBlur='checkAvailability1()'  onChange='getSeater(this.value);' class='form-control'>
<span id='user-availability-status1' style='font-size:12px;'></span>
</div>
</div>

<input type='hidden' name='parent' id='parent_id' class='form-control'>
