	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:4%">Downline details</h2>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th>Fullname</th>
											<th>Reg no</th>
											<th>Sponsor Usename</th>
											<th>Parent Usename</th>
											<th>Email</th>
...
while($row1=mysqli_fetch_array($tr))
	  {
$id=$row1['MAX(id)'];
$ret="select * from userregistration where id > '$aid' and id<='$id'";
