...
elseif (($dowmline>=200 && $dowmline<500) && ($direct>=4)) {
	$income=(200)+100;
}
elseif (($dowmline>=500) && ($direct<=4 && $direct>=3)) {
	$income=100;
}
elseif (($dowmline>=500 && $dowmline<800) && ($direct>=5)) {
	$income=(300)+300;
}
elseif (($dowmline>=800) && ($direct<=5)) {
	$income=300;
}
elseif (($dowmline>=800 && $dowmline<1500) && ($direct>=6)) {
	$income=(500)+600;
}
elseif (($dowmline>=1500) && ($direct<=6 )) {
	$income=600;
}
elseif (($dowmline>=1500 && $dowmline<2500) && ($direct>=8)) {
	$income=(700)+1100;
}
elseif (($dowmline>=2500) && ($direct<=8)) {
	$income=1100;
}
elseif (($dowmline>=2500 && $dowmline<3500) && ($direct>=10)) {
	$income=(1000)+1800;
}
elseif (($dowmline>=3500) && ($direct<=10)) {
	$income=1800;
}
elseif (($dowmline>=3500 && $dowmline<5000) && ($direct>=14)) {
	$income=(1200)+2800;
}
elseif (($dowmline>=5000) && ($direct<=14)) {
	$income=2800;
}
elseif (($dowmline>=5000 && $dowmline<8000) && ($direct>=17)) {
	$income=(1500)+4000;
}
elseif (($dowmline>=8000) && ($direct<=17)) {
	$income=4000;
}
elseif (($dowmline>=8000 && $dowmline<12000) && ($direct>=30)) {
	$income=(8000)+5500;
}
elseif (($dowmline>=12000) && ($direct<=30)) {
	$income=5500;
}
elseif (($dowmline>=12000 && $dowmline<20000) && ($direct>=35)) {
	$income=(15000)+13500;
}
elseif (($dowmline>=20000) && ($direct<=35)) {
	$income=13500;
}
elseif (($dowmline>=20000 && $dowmline<30000) && ($direct>=40)) {
	$income=(30000)+28500;
}
elseif (($dowmline>=30000) && ($direct<=40)) {
	$income=28500;
}
elseif (($dowmline>=30000 && $dowmline<50000) && ($direct>=45)) {
	$income=(60000)+58500;
}
elseif (($dowmline>=50000) && ($direct<=45)) {
	$income=58500;
}
elseif (($dowmline>=50000 && $dowmline<70000) && ($direct>=50)) {
	$income=(100000)+118500;
}
elseif (($dowmline>=70000) && ($direct<=50)) {
	$income=118500;
}
elseif (($dowmline>=70000 && $dowmline<100000) && ($direct>=60)) {
	$income=(130000)+128500;
}
elseif (($dowmline>=100000) && ($direct<=60)) {
	$income=128500;
}
